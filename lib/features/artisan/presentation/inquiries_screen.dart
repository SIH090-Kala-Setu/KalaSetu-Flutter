        ...
        setState(() {
          _inquiries = [
            InquiryModel(
              id: 'inq_1',
              productId: 'prod_1',
              buyerName: 'FabIndia Retail Procurement',
              buyerEmail: 'procurement@fabindia.com',
              quantity: 50,
              message: 'We want 50 pieces of Banarasi Handloom Scarves for upcoming festive season. Can you deliver by next month?',
              status: 'Pending',
            ...
            InquiryModel(
              ...
              quantity: 25,
              message: 'Looking for custom glazed terracotta vases with specific indigo patterns.',
              status: 'Responded',
              createdAt: 'Yesterday',
            ),
            InquiryModel(
              id: 'inq_3',
              productId: 'prod_3',
              buyerName: 'Tribal Co-op Heritage Store',
              buyerEmail: 'tribal@coop.org',
              quantity: 100,
              message: 'Bulk procurement for state trade fair pavilion.',
              status: 'Completed',
                ...
                children: [
                  Expanded(
                    child: AppButton(
                      ...
                      onPressed: () async {
                        final apiClient = ref.read(apiClientProvider);
                        await apiClient.respondToInquiry(inquiry.id, replyController.text.trim().isNotEmpty ? replyController.text.trim() : 'We accept your request.');
      ...
      body: _isLoading
          ...
          : _inquiries.isEmpty
              ? EmptyStateWidget(
                  ...
                  message: 'When B2B wholesale buyers request quotes for your products, they will appear here.',
                )
              : ListView.builder(
